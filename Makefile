...
security-checks:
	...
	shellcheck install.sh uninstall.sh entrypoint scripts/bin/install scripts/bin/uninstall scripts/bootstrap/install_aichat.sh; \
	shfmt -d install.sh uninstall.sh entrypoint scripts/bin/install scripts/bin/uninstall scripts/bootstrap/install_aichat.sh; \
