...
class TestServiceHealth:
    ...
    def test_mcp_tools_list(self):
        ...
        for expected in ("screenshot", "web_search", "memory_store", "ocr_image",
                         "image_caption", "face_recognize", "code_run", "vector_store",
                         "think", "deep_research", "realtime", "news_search",
                         "wikipedia", "arxiv_search", "youtube_transcript",
                         "jupyter_exec", "desktop_screenshot", "desktop_control"):
