...
from .personalities import DEFAULT_PERSONALITY_ID, default_personalities, merge_personalities

# Default LM Studio endpoint – override via LM_STUDIO_URL env var or config file.
_DEFAULT_BASE_URL = os.environ.get("LM_STUDIO_URL", "http://192.168.50.2:1234")
